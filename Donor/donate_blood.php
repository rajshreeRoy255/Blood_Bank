...
<body>
    <!-- form start -->
    <form action="donate_blood_sq.php" method="POST" enctype="multipart/form-data">
    <div class="container-fluid my-3 mb-4">
        <h2 class="text-center border_bottom">Blood Donation Form</h2><hr>
            <div class="row d-flex align-item-center justify-content-center shadow-lg">
                <div class="col-lg-12 col-xl-6">
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <!-- button -->
                        <div class="form-outline mb-4">
                            <input type="submit" value="Send Request" class="btn btn-info" name="donate_submit">
                        </div>
